<%@ page import="Model.BEANS.C_ChefBrigade" %>
<!-- Header - informations -->
<%@include file="../Layout/header.jsp" %>
<%
    C_ChefBrigade chef = null;
    if (session.getAttribute("chefBrigade") != null)
	...
	<header>	
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  			...
  			<div class="collapse navbar-collapse" id="navbarNav">
    			<ul class="navbar-nav">			     			
      				<li class="nav-item">
        				<a class="nav-link" href="${pageContext.request.contextPath}/ListerAmende"><i class="fas fa-file-alt mx-2"></i>Consulter amende</a>
      				</li>
    			</ul>
    			<ul class="navbar-nav">			     			
      				<li class="nav-item">
		...
		<!-- Titre -->
        <h1>Bienvenue : <%=chef.getPrenom().substring(0, 1)%>. <%=chef.getNom() %></h1>
        <div class="lineTitre"></div> 
	</header>
	
	<div class="text-center">
		<p>Bienvenue sur votre portail personnel ! Vous pouvez consulter les amendes de votre coprs de police afin de pouvoir y intervenir dessus. <br>
