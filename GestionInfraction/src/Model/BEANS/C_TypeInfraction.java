...
public class C_TypeInfraction implements Serializable{
	...
	// Ajouter une amende dans liste
	public void ajouterAmende(C_TypeVehicule vehi, C_Policier pol, String immatriculation, String pays, String ville, double montant, String commentaire) {
		listeAmende.add(new C_Amende(this, vehi, pol, immatriculation, pays, ville, montant, commentaire));
	}
	
	// Description date fin
	public String getNomDateFin() {
		if(dFin != null)
			return dFin.toString();
