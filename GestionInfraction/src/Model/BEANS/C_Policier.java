...
public class C_Policier extends C_Utilisateur{
	...
	public void ajouterAmende(C_Amende amende) {
		listeAmende.add(new C_Amende(amende.getId(), amende.getTypeVehi(), this, amende.getContrevenant(), amende.getImm(), 
				amende.getInstant(), amende.getVille(), amende.getMontant(), 
