...
/**
 * Servlet implementation class ActiverUtilisateur
 */
@WebServlet("/ActiverUtilisateur")
public class ActiverUtilisateur extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActiverUtilisateur() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(admin.activerUtilisateur(uti))
