...
/**
 * Servlet implementation class InvaliderAmende
 */
@WebServlet("/InvaliderAmende")
public class InvaliderAmende extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InvaliderAmende() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 4. Supprimer amende
		if(chef.invaliderAmende(amende))
